...
export function hashToTaskRecord(hash: Record<string, string>): TaskRecord {
  ...
  return {
    ...
    cancelled_at: hash.cancelled_at ? Number(hash.cancelled_at) : undefined,
    cancel_reason: hash.cancel_reason || undefined,
    fix_for: hash.fix_for || undefined,
    repair_root_task_id: hash.repair_root_task_id || undefined,
    trigger_review_task_id: hash.trigger_review_task_id || undefined,
